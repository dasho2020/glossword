	...
	public function page_footer()
	{
		...
		switch ($this->gv['sef_output'])
		{
			...
			default:
				...
				$this->oTpl->assign( 'href:output_js', $this->oHtml->url_normalize( $this->V->server_dir.'/'.$this->V->file_index.'?arg[target]=js&arg[sef_output]=js&arg[files]='. str_replace(',', "\x01\x01", $this->oOutput->get_js_collection()) ) );
				$this->oTpl->assign( 'href:output_css', $this->oHtml->url_normalize( $this->V->server_dir.'/'.$this->V->file_index.'?arg[target]=css&arg[sef_output]=css&arg[files]='. str_replace(',', "\x01\x01", $this->oOutput->get_css_collection() ) ) );
